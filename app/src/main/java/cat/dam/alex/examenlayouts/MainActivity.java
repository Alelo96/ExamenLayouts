...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View child = getLayoutInflater().inflate(R.layout.activity_main_ex1, null);
        ...
        btn_lyt2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                fl_content.removeAllViews();
                View child = getLayoutInflater().inflate(R.layout.activity_main_ex2, null);
                fl_content.addView(child);
            }
        });
        btn_lyt3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                fl_content.removeAllViews();
                View child = getLayoutInflater().inflate(R.layout.activity_main_ex3, null);
                fl_content.addView(child);
            }
        });
    }
